...
#INSTANCIA EL MINIJUEGO DENTRO DEL MARCO (UN Control CON clip_contents) DE LA OFICINA.
#NO SE USA UN SubViewport A PROPÓSITO: ESE RASTERIZA A BAJA RESOLUCIÓN Y LUEGO AMPLÍA, LO QUE
#EMBORRONA EL PIXEL ART. ASÍ EL MINIJUEGO SE DIBUJA EN EL CANVAS PRINCIPAL Y EL MARCO SOLO RECORTA,
#DEJANDO VER LA OFICINA ALREDEDOR. POR ESO LAS ESCENAS DE MINIJUEGO LLEVAN SU Camera2D DESACTIVADA
