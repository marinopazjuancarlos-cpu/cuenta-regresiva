...
func _ready() -> void:
	...
	$gas2/Timer2.wait_time = float(randi_range(4,7))
	$gas3/Timer3.wait_time =float(randi_range(4,7))
	$gas4/Timer4.wait_time =float(randi_range(4,7))
	$gas5/Timer5.wait_time =float(randi_range(4,7))
